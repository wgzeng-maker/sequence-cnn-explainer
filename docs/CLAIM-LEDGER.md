...
| C08 | Residual diagonal energy | D | Qualified | “Only about 0.24–0.40% of K562 residual squared-weight energy lies on same-index channel connections.” | “99.6% of the model's prediction is cross-channel cooperation.” |
| C09 | Effective input channels | D | Qualified | “Entropy-based effective input-channel counts are high, supporting broad weight distribution across input channels.” | “This is the exact number of biological features used.” |
...
| B07 | K562 output example | X | Qualified | “For the official tutorial sequence, the K562 reader outputs approximately 0.9061 and ranks 13th among 164 labels.” | “The sequence is experimentally 90.61% accessible in K562.” |
